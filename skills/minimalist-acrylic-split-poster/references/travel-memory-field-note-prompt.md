...
调用 ImageGen 前概括照片中的核心主体、观察方向、姿态或空间路径、主要环境层次和情绪。人物、动物、建筑或物品都可成为“记忆锚点”；无人物时，用最具识别性的建筑、道路、树、山、水岸或室内物体承担主角。

## 核心表达

将原照片重绘为一页高级旅行记忆档案：透明而克制的水彩色块、细腻铅笔或针管笔线稿、局部未完成轮廓、大量温暖象牙色纸张，以及像现场速写般自然的观察痕迹。

保留主体最重要的身份、轮廓、姿态、方向和环境关系，但主动删减摄影细节。主角需要一眼可辨，周围景观以松散水彩、断续线条和少量擦写痕迹提示。允许部分轮廓超出色块，允许天空、云、远山、植被或建筑在纸张中自然消失。
...
背景使用温暖象牙色、天然纸纤维和轻微旧纸颗粒。主色从照片提取并降低饱和度，例如苔藓绿、橄榄绿、鼠尾草绿、灰蓝、暖灰、土黄和炭灰。仅允许一个小面积暖橙、砖红或赭色用于标题系统之外的视觉强调。

水彩应保留纸张透光感、轻微水痕、干湿交界和叠色，但不使用糖果色、霓虹或高饱和渐变。
...
luxury travel memory field note, transparent watercolor and fine ink sketch, warm ivory paper, observational drawing, selective unfinished contours, muted natural palette, poetic walking memory, editorial archive, independent travel magazine, contemporary exhibition booklet, large left negative space, right-weighted illustration, mature hand-drawn linework, subtle paper grain
